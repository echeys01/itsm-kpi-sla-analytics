...
Analysis of anonymized, non-synthetic Rabobank IT service desk data from the **2014 BPI Challenge** to practice building real-world SLA-like metrics, reporting KPIs, and constructing an ITSM visualization layer that is presented with Excel and Power BI.
